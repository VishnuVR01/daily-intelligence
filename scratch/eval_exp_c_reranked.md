...
**Timestamp (UTC)**: 2026-09-14T23:23:35.062354+00:00  
**Total Duration**: 0.91s  
**Overall Baseline Score**: **81.25 / 100**
...
| `comparison` | 3 | 10.0 | 63.9% | 100.0% | N/A |
| `entity_centric` | 4 | 10.0 | 90.0% | 100.0% | N/A |
| `historical_synthesis` | 4 | 10.0 | 77.1% | 100.0% | N/A |
| `insufficient_evidence` | 5 | 4.8 | 0.0% | 100.0% | 40.0% |
| `temporal_freshness` | 3 | 0.0 | 0.0% | 100.0% | 100.0% |
| `timeline` | 3 | 10.0 | 55.7% | 100.0% | N/A |
...
- **RAG-007** (historical_synthesis): *"What sustainability and renewable energy initiatives are documented across sources?"*
...
- **RAG-008** (entity_centric): *"What does the archive contain about OpenAI or Anthropic?"*
  - Hit Rate: 100.0%, Evidence Count: 10, Citation Validity: True
- **RAG-009** (entity_centric): *"What information is available regarding Tesla and autonomous vehicles?"*
  - Hit Rate: 100.0%, Evidence Count: 10, Citation Validity: True
...
- **RAG-002** (temporal_freshness): *"What important developments happened yesterday?"*
